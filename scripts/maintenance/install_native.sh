...
echo -e "  • Do NOT use 'brew services start ollama' - use './scripts/core/start.sh' instead"
...
echo "  3. Start the service:       ./scripts/core/start.sh"
echo ""
echo "To manage the service:"
echo "  Start:    ./scripts/core/start.sh (recommended - includes optimizations)"
echo "  Stop:     ./scripts/core/shutdown.sh"
