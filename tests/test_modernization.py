...
class TestPerformanceLogging:
    ...
    def test_performance_collector_records_metrics(self):
        ...
        assert "qwen3-vl:8b-instruct-q4_K_M" in stats["by_model"]
...
class TestProjectTracking:
    ...
    def test_track_request_with_project_context_manager(self):
        ...
        with track_request_with_project(
            "qwen3-vl:8b-instruct-q4_K_M", "generate", project="test_project"
        ):
            time.sleep(0.01)
...
class TestTypeHints:
    ...
    def test_generator_type_hints_track_request(self):
        ...
        MetricsCollector.reset()
        cm = track_request("qwen3-vl:8b-instruct-q4_K_M", "generate")
    ...
    def test_generator_type_hints_track_request_with_project(self):
        ...
        MetricsCollector.reset()
        cm = track_request_with_project("qwen3-vl:8b-instruct-q4_K_M", "generate", project="test")
