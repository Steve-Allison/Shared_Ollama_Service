...
def check_service_health(base_url: Optional[str] = None, timeout: int = 5) -> tuple:
    """
...
def ensure_service_running(base_url: Optional[str] = None, raise_on_fail: bool = True) -> bool:
    """
...
def get_client_path() -> Optional[Path]:
    """
